...
/**
 * Pull remote bytes via the platform layer. Electron routes through main to
 * dodge CORS; web hits the URL directly so the storage host MUST send
 * Access-Control-Allow-Origin or this will throw.
 */
